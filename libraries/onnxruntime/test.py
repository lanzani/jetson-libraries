...
def test_infer(provider, model="resnet18.onnx", runs=100, warmup=10, verbose=False):
    ...
    session = ort.InferenceSession(
        model, sess_options=session_options, providers=[provider], provider_options=[provider_options]
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-url", type=str, default="https://nvidia.box.com/shared/static/zlvb4y43djygotpjn6azjhwu0r3j0yxc.gz"
    )
